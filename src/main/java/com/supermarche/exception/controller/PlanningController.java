...
public class PlanningController {
    ...
    @FXML private ComboBox<String> champPoste;
    ...
    @FXML public void initialize() {
        ...
        champPoste.setItems(FXCollections.observableArrayList("Caissier","Employé de magasin","Manager"));
    ...
    private void afficherPlanning(Planning planning) {
        ...
        champPoste.setValue(planning.getPoste());
    ...
    private void enregistrerPlanning() {
        try {
            ...
            planning.setPoste(champPoste.getValue());
            ...
            DialogueUtil.afficherErreur("Erreur1",e.getMessage());
        }
    }
