...
public class ProduitsController {
    ...
    private void nouveauProduit() {
        ...
        // Sans ce reset, la photo choisie pour le produit precedent
        // restait en memoire et etait recopiee sur le produit suivant
        // si on ne selectionnait pas de nouvelle photo avant d'enregistrer.
    ...
    private void enregistrerProduit() {
        try {
            ...
            boolean creation = (produitSelectionne == null);
            if (creation) {
            ...
            // La copie de la photo doit avoir lieu APRES la persistance :
            // pour un nouveau produit, p.getId() n'est assigne par la BD
            // qu'au moment de creerProduit(). La faire avant ecrivait le
            // fichier sous le nom "null.jpg", jamais retrouve ensuite.
            ...
            DialogueUtil.afficherInfo(
                    creation ? "Produit cree" : "Produit modifie",
                    creation ? "Le produit a ete ajoute au catalogue." : "Les modifications ont ete enregistrees.");
            rechercher();
            nouveauProduit();
